...
class TestP28 extends FlatSpec with Matchers {
  import P28._
  "lsort of P28" should "sort the elements of the list according to their length. E.g. short lists first, longer lists later, or vice versa." in {
  ...
  "lsortFreq of P28" should "sort the elements according to their length frequency." in {
